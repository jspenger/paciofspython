...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(parents=[PacioFSServer._Parser(), blockchainfs.BlockchainFS._Parser(), blockchainbroadcast.BlockchainBroadcast._Parser(), blockchain.Blockchain._Parser()])
    ...
    bfs = BlockchainFSOperationsRPC._Init(args)
